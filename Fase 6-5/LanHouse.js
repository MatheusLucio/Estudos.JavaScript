...
function computadoresWindows(computadores) {
  const computadoresComWindows = computadores.filter((computador) => {
    return computador.sistemaOperacional === 'Windows'
  })
  return computadoresComWindows
}

console.log(computadoresWindows([computador1, computador2, computador3, computador4, computador5, computador6]))
console.log('------------------------------------------')
